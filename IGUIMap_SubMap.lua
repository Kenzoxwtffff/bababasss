...
---@param worldPos Vector3
---@param radius number
---@param colorOutside ImVec4
---@param colorInside ImVec4
function IGUIMap_SubMap:drawWorldCircleFilledGradient(worldPos, radius, colorOutside, colorInside)
end
...
---@param worldPosA Vector3
---@param worldPosB Vector3
---@param color ImVec4
---@param thickness number
---@param filled boolean
function IGUIMap_SubMap:drawWorldRectangleAB(worldPosA, worldPosB, color, thickness, filled)
end
...
---@param worldPoints Vector3[]
---@param color ImVec4
---@param thickness number
---@param filled boolean
function IGUIMap_SubMap:drawWorldPolygon(worldPoints, color, thickness, filled)
end
